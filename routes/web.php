...
Route::prefix('shop')->group(function(){
    ...
    Route::get('',[App\Http\Controllers\Front\ShopController::class,'index'])->name('shop');
...
Route::prefix('checkout')->group(function(){
    Route::get('',[\App\Http\Controllers\Front\CheckoutController::class,'index'])->name('checkout.show');
