                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="size" id="size" class="form-control">
                                        ...
                                        <option value="S" {{ $productDetail->size == 'S' ? 'selected' : '' }}>
                                            S
                                        </option>
                                        <option value="M" {{ $productDetail->size == 'M' ? 'selected' : '' }}>
                                            M
                                        </option>
                                        <option value="L" {{ $productDetail->size == 'L' ? 'selected' : '' }}>
                                            L
                                        </option>
                                        <option value="XS" {{ $productDetail->size == 'XS' ? 'selected' : '' }}>
                                            XS
                                        </option>
                                    </select>
                                </div>
