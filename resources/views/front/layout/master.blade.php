...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="front/img/Shop.ico">
</head>
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                                    ...
                                                    <tr data-rowId="{{ $cart->rowId }}">
                                                        ...
                                                        <td class="si-text">
                                                            <div class="product-selected">
                                                                <p>${{ $cart->price }} x <span id="qty-{{ $cart->rowId }}">{{ $cart->qty }}</span></p>
                                                                <h6>{{ $cart->name }}</h6>
                                                            </div>
                                                        </td>
                                                        <td class="si-close">
                                    ...
                                    <div class="select-total">
                                        <span>total:</span>
                                        <h5 class="cart-price">${{ Cart::total() }}</h5>
                                    </div>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            ...
                            <li>Email: longnhat51@gmail.com</li>
                        </ul>
