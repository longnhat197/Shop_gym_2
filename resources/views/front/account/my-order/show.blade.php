                ...
                <div class="col-lg 6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" disabled id="last" value="{{ $order->last_name }}">
                        </div>
                        <div class="col-lg-12">
                            <label for="cun-name">Company Name</label>
                            <input type="text" id="cun-name" disabled value="{{ $order->company_name }}">
                        </div>
                        <div class="col-lg-12">
                            <label for="cun">Country</label>
                            <input type="text" id="cun" disabled value="{{ $order->country }}">
                        </div>
                        <div class="col-lg-12">
